...
The SCPI commands are found on the manual guide of ZNL:
"ZNL_ZNLE_UserManual_en_20.pdf"
https://www.rohde-schwarz.com/manual/znl/
"""
...
def read_traces(address='GPIB0::6::INSTR', num_sweeps=1, 
    ...
    timeout : int
        ...
        Returns
    turn_fact_cal_off : boolean  (command not available)
    ...
    with pyvisa.ResourceManager('@py').open_resource(address) as vna:
        ...
        vna.write('SYSTem:COMMunicate:INTernal:REMote OFF') # go to local (exit remote)
...
if __name__=='__main__':
    frequencies, measurements, trace_definitions = read_traces(address='TCPIP0::169.254.45.85::inst0::INSTR', 
                                                               num_sweeps=10)
